...
| **Integrity gate** (`src/lib/integrity.mjs`) | deterministic | word-level text-loss, image-loss, pixel diff localized to allowed regions; research shows ~30% of unguarded LLM patches damage structure |
